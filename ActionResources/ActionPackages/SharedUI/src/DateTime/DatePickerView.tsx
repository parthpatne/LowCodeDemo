...
import { Input, Popup, Icon } from '@stardust-ui/react';
...
import { Constants, UxUtils } from '../common';

registerIcons({
    icons: {
        'chevronLeft': <Icon name="chevron-down" rotate={90} />,
        'chevronRight': <Icon name="chevron-down" rotate={270} />
    }
});
