...
import { Input, InputProps, Text, Flex, ShorthandValue, IconProps } from "@stardust-ui/react";
import { IErrorProps } from "../common";
import * as ActionSDK from "@actionSDK";

export interface IInputBoxProps extends IErrorProps, InputProps {
    multiline?: boolean;
    prefixJSX?: JSX.Element;
}

const errorIcon: ShorthandValue<IconProps> = {
