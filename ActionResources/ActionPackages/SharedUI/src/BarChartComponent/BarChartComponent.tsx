...
import { IErrorProps, IUIProps } from "@sharedUI";
import "./BarChartComponent.scss";
import { Flex, Text, FlexItem } from "@stardust-ui/react";
import { ShimmerContainer } from "../ShimmerLoader";

export interface IBarChartComponentProps extends IErrorProps, IUIProps {
    items: IBarChartItem[];
